...
export const createReminder = asyncWrapper(
...
export const getReminders = asyncWrapper(
  async (req: CustomRequest, res: Response) => {
    const { id: userId } = req.user!;
...
export const getTaskReminders = asyncWrapper(
  async (req: CustomRequest, res: Response) => {
    const { id: userId } = req.user!;
    ...
    return ApiResponse.success(
      res,
      { reminders },
      'Task reminders retrieved successfully',
    );
  },
);

export const updateReminder = asyncWrapper(
  async (req: CustomRequest, res: Response) => {
    const { id: userId } = req.user!;
...
export const deleteReminder = asyncWrapper(
  async (req: CustomRequest, res: Response) => {
    const { id: userId } = req.user!;
    const { id: reminderId } = req.params;
